...
class ResourceBinder(private val context: Context) : Binder {
    ...
    override fun bindBoolean(@BoolRes resId: Int) =
        lazy(NONE) { context.resources.getBoolean(resId) }

    override fun bindInt(@IntegerRes resId: Int) =
        lazy(NONE) { context.resources.getInteger(resId) }
