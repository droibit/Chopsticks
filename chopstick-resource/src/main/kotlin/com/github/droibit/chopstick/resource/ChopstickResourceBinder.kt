...
class ResourceBinder(private val context: Context) : Binder {
    ...
    override fun bindDrawable(@DrawableRes resId: Int) = lazy { ContextCompat.getDrawable(context, resId) }
    ...
    override fun bindStringArray(@ArrayRes resId: Int) = lazy { context.resources.getStringArray(resId) }
    ...
    override fun bindDimensionPixel(@DimenRes resId: Int) = lazy { context.resources.getDimensionPixelSize(resId) }
}